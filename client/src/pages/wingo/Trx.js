      ...
      >
        ...
        <div className="relative">
          <div className="nav-bg mt-5 p-2">
            ...
            <div className="bg-navs mt-2 p-2 rounded-lg">
          ...
          {openTime && (
            <div className="flex items-center blue-color-300 justify-center absolute z-10 m-auto top-0 bottom-0 left-0 right-0 ">
              <span className="text-[150px] bg-[#3C3775] text-[#A08FFF] font-medium rounded-xl mr-6 w-32 h-[180px] flex items-center justify-center">
                0
              </span>
        ...
        {gameHistory == "ghistory" && (
          <div className="text-white">
            <div className="grid grid-cols-10 bg-[#3C3775] text-white rounded-t-md p-2 mt-5">
