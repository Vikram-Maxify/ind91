  ...
  return (
    <>
      ...
      <div className="container-section mt-5">
        ...
        <h3 className="heading-h2 text-center text-[#cec6ce]">
          Interpretation and Definitions
        </h3>
        <h3 className="heading-h3 text-center text-[#cec6ce]">Interpretation</h3>
      ...
      <div className="container-section mt-5">
        ...
        <h2 className="heading-h2 text-center text-[#cec6ce]">
          Interpretation and Definitions
        </h2>
        <h3 className="heading-h3 text-center text-[#cec6ce]">Interpretation</h3>
        <p className="fs-sm text-[#cec6ce]">
        ...
        <h3 className="heading-h3 text-center text-[#cec6ce]">Definitions</h3>
        <p className="fs-sm text-[#cec6ce]">
        ...
        <ul>
          ...
          <li>
            ...
            <text className="color-blue-500">https://gwggame.com</text>
          </li>
          <li>
        ...
        <h3 className="heading-h3 text-center text-[#cec6ce]">
          Types of Data Collected
        </h3>
        <h3 className="heading-h3 text-center text-[#cec6ce]">Personal Data</h3>
        <p className="fs-sm text-[#cec6ce]">
        ...
        <h3 className="heading-h3 text-center text-[#cec6ce]">Usage Data</h3>
        <p className="fs-sm text-[#cec6ce]">
        ...
        <ul>
          <li>
            ...
            <p className="fs-sm text-[#cec6ce]">Type: Session Cookies</p>
            <p className="fs-sm text-[#cec6ce]">Administered by: Us</p>
            <p className="fs-sm text-[#cec6ce]">
          ...
          <li>
            ...
            <p className="fs-sm text-[#cec6ce]">Type: Persistent Cookies</p>
            <p className="fs-sm text-[#cec6ce]">Administered by: Us</p>
            <p className="fs-sm text-[#cec6ce]">
        ...
        <h3 className="heading-h3 text-center text-[#cec6ce]">Law enforcement</h3>
        <p className="fs-sm text-[#cec6ce]">
        ...
        <h2 className="heading-h2 text-center text-[#cec6ce]">Children's Privacy</h2>
        <p className="fs-sm text-[#cec6ce]">
        ...
        <h2 className="heading-h2 text-center text-[#cec6ce]">Contact Us</h2>
        <p className="fs-sm text-[#cec6ce]">
